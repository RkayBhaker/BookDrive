...
<div class="container-fluid bg-secondary bg-opacity-25 p-3 sticky-top" id="sticky-top">
    <p>
         > <a href="{{ route('admin.panel') }}">ADMIN PANEL</a> / USER DETAILS
    </p>
</div>

<!-- Available Data in database -->
<h4 class="p-4 my-1 text-center bg-primary bg-opacity-25">USER DETAILS</h4>
<div class="table-responsive-sm container">
<table class="table my-5 table-bordered border-primary table-hover">
  <thead>
    <tr>
      <th scope="col">#</th>
